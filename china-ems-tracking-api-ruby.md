China EMS Tracking API - Node.js
================================
Use Node.js to track China EMS shipments with China EMS Tracking API.
...
Create a tracking (Real-time tracking):
      ...
      begin
        params  = {"tracking_number" => "0301006785462006320995","courier_code"=>"china-ems"}
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    begin
      params  = [{"tracking_number" => "LK201223662AU","courier_code"=>"china-ems"},{"tracking_number" => "LH290032509AU","courier_code"=>"china-ems"}]
...
Get status of the shipment:
    ...
    begin
      ...
      # params  = {"courier_code"=>"china-ems"}
      # params  = {"tracking_numbers" => "LK201223662AU,LH290032509AU","courier_code"=>"china-ems"}
